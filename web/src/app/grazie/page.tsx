...
export default function GraziePage() {
  return (
    <div className="mx-auto max-w-lg px-4 py-16 text-center">
      ...
      <Link
        href="/"
        className="mt-8 inline-flex min-h-12 items-center justify-center rounded-full bg-gradient-to-br from-brand to-brand-rust px-6 font-headline font-bold text-white"
      >
        Torna alla home
      </Link>
    </div>
